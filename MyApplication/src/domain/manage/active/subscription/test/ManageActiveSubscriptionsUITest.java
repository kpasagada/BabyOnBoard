...
public class ManageActiveSubscriptionsUITest {
	...
	@Test
	public void viewActiveSubscriptionTest() throws InterruptedException {
		...
		WebElement activeSubscriptionTab = mainTab.findElement(By.id("tab1"));
		assertEquals(activeSubscriptionTab.getAttribute("aria-controls"), "Subscriptions");
		
	}
	
	@Test
	public void deleteActiveSubscriptionTest() throws InterruptedException {
		...
		//WebElement subscriptionTab = transactionTab.findElement(By.className("tab-panel"));
